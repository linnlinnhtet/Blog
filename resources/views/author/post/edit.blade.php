...
@section('title', 'Author Update Post')
                                        ...
                                        <div class="form-inline {{ $errors->has('tags')?'focused error':'' }}">
                                            ...
                                            <select name="tags[]" id="tag" class="form-control show-tick" data-live-search="true" multiple>
                                                @foreach ($tags as $tag)
                                                    ...
                                                    @endforeach style="margin-left: 50px" value="{{ $tag->id }}">{{ $tag->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <a class="btn btn-danger m-t-15 wave-effect" href=" {{route('author.post.index')}} ">BACK</a>
